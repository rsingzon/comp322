...
int main() {
    ...
    wg.push_page(make_wiki_page(path + "wiki/wp/c/Canada.htm",
                                path + "wiki/text/Canada.txt"));
    wg.push_page(make_wiki_page(path + "wiki/wp/u/University_of_Chicago.htm",
                                path + "wiki/text/University_of_Chicago.txt"));
    wg.push_page(make_wiki_page(path + "wiki/wp/v/Vancouver.htm",
                                path + "wiki/text/Vancouver.txt"));
